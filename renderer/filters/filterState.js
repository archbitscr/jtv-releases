...
export const eventIconsList = [
    { name: '⚽', color: '#ffffff', label: 'Fútbol' },
    { name: '🏀', color: '#f97316', label: 'Baloncesto / NBA' },
    { name: '🏈', color: '#b45309', label: 'Fútbol Americano / NFL' },
    { name: '⚾', color: '#f8fafc', label: 'Béisbol / MLB' },
    ...
    { name: '🏸', color: '#38bdf8', label: 'Bádminton' },
    { name: '🏒', color: '#64748b', label: 'Hockey sobre Hielo' },
    { name: '🏑', color: '#15803d', label: 'Hockey sobre Césped' },
    ...
    { name: '🎞️', color: '#475569', label: 'Película' },
    { name: '🎤', color: '#06b6d4', label: 'Micrófono / Shows' },
    { name: '🎧', color: '#6366f1', label: 'DJ / Audición' },
    { name: '🎵', color: '#ec4899', label: 'Nota Musical' },
    { name: '🎶', color: '#14b8a6', label: 'Melodía / Concierto' },
    { name: '🎸', color: '#ef4444', label: 'Guitarra / Rock' },
    { name: '🎹', color: '#475569', label: 'Piano' },
    { name: '🎻', color: '#b45309', label: 'Violín' },
    { name: '🎷', color: '#f59e0b', label: 'Saxofón' },
    { name: '🥁', color: '#f43f5e', label: 'Batería' },
    { name: '📻', color: '#d97706', label: 'Radio' },
    { name: '📺', color: '#10b981', label: 'Televisión' },
    { name: '📸', color: '#06b6d4', label: 'Cámara' },
    { name: '🎉', color: '#f59e0b', label: 'Fiesta / Año Nuevo' },
    { name: '🎊', color: '#ec4899', label: 'Celebración' },
    ...
    { name: '❤️', color: '#ef4444', label: 'Corazón Rojo' },
    { name: '🖤', color: '#475569', label: 'Corazón Negro' },
    { name: '💬', color: '#3b82f6', label: 'Charla' },
    { name: '📢', color: '#06b6d4', label: 'Anuncio' },
    { name: '📣', color: '#f59e0b', label: 'Vocero / Megáfono' },
    ...
    { name: '💪', color: '#f59e0b', label: 'Fuerza / Bíceps' },
    { name: '✊', color: '#f59e0b', label: 'Puño Alzado' },
    { name: '👊', color: '#f59e0b', label: 'Puño' },
    { name: '🤜', color: '#f59e0b', label: 'Puño Derecho' },
    { name: '🤛', color: '#f59e0b', label: 'Puño Izquierdo' },
    { name: '👍', color: '#3b82f6', label: 'Like' },
    { name: '🤝', color: '#10b981', label: 'Acuerdo' },
    { name: '🍀', color: '#22c55e', label: 'Trébol / Suerte' },
